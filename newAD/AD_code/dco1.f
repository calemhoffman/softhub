	PROGRAM DCO1
c       A program to calculate DCO ratios.  I have moved this from the VAXs
c       to UNIX machines 1-10-2000 (SLT).  DCO1 seems to differ from DCO by
c       asking if there are any known intermediate transitions.  If NO, it
c       calculates a correction anyway.  If YES, it asks for info on the
c       transitions and calculates the correction.  DCO1 also calculates the
c       E(gam(2)..gam(n-1)) factors defined in eq. 15.7 in Hamilton.  In
c       general, DCO1 seems to reference Hamilton whereas DCO only references
c       Krane and Stephens.  The printouts around statements 300 are not
c       commented out in DCO as they are here in DCO1.
c       There is also some difference in the functions defined.  DCO1 defines
c       XFAC and P, whereas DCO uses HFAC and YLM. 

	DIMENSION IP(10),JP(10),THETA(10),PHI(10,10),UFAC(19)
	DIMENSION RDCO(2,181),W(181),AI1(2),EFF(10,2),E(2)
	CHARACTER*1 ANS
	REAL*8 XX,YY,ERR,FACT,XMIN,XMAX
	COMMON/ALAMB/ALAM(3),ALAM1(19),ALAM2(19),Q(19),BLAM1(2,3)
	COMMON/ANGLE/RAD,PI
	COMMON/ALMIX/DEL34,ALI(2),ALIP(2),ALG,ALGP
	COMMON/DETEC/AD(10),BD(10),CD(10),DD(10)
	COMMON/ECOEF/EFAC(19)
	COMMON/FCOEFS/FO11(19),FO12(19),FO22(19),
     +  FG11(2,3,19),FG12(2,3,19),FG22(2,3,19)
...
C
1	WRITE(6, 100)
100	FORMAT(' PROGRAM DCO1 - CONVENTIONS OF STEFFEN, ALDER, TWIN,
     +  AND HAMLITON'                          
...
460	WRITE(6,*)' TYPE IN # OF DETECTORS'
	...
	write(6,*)'Note: 1-10-2000, SLT: Parts of this correction have'
	write(6,*)'been commented out.  Use with caution!!!'
	READ(5,*)E(1),E(2)
...
26	   EFF(N,NE)=1.0
	...
	write(6, *)' For the usual definition of DCO, det.1 should be near'
	write(6, *) '90 deg.'
...
C	WRITE(6,*)' RDCO(2,90),RDCO(2,91)=',RDCO(2,90),RDCO(2,91)
	...
	ENDIF
C
	WRITE(4,300)AI1(1),AI1(2),AI2,SIGMA,AI3,AI4,DEL34
300	FORMAT(/' INITIAL SPINS =',F4.1,',',f4.1,' FINAL SPIN =',F4.1
...
303	FORMAT(/'ARCTAN(DELTA)  RDCO(DELTA)')
	DO 304 I=1,181
	 IDEL=91-I
	 WRITE (4,305)IDEL,RDCO(1,I),RDCO(2,I)
304	CONTINUE 
305 	FORMAT(I5,12X,F5.2,9X,F5.2)
	STOP
	END
C
C	**************************************************************
