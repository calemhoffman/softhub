...
python3.11 process_multistate.py
if [ $? -ne 0 ]; then
...
echo "--------------------------------------------------------"
python3.11 collect_independent_fits.py

# 4. Generate Independent Summary Plot
echo "--------------------------------------------------------"
echo "Step 4: Generating Independent Summary Visualization"
echo "--------------------------------------------------------"
python3.11 plot_multistate_independent.py

# 5. Generate LaTeX Table and Normalized Plot
echo "--------------------------------------------------------"
echo "Step 5: Generating LaTeX Table and Normalized Plot"
echo "--------------------------------------------------------"
python3.11 generate_summary_artifacts.py
